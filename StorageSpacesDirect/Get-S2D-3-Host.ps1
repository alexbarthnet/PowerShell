...
$host_list | Sort-Object Host -Unique | ForEach-Object {
	...
	Invoke-Command -Session $pss_main -ScriptBlock {
		...
		$file_output1 = $using:out_adapter | Format-Table Name, Description, Index, Status, MacAddress, LinkSpeed, Slot, Port, PciLabel, NumVFs
...
Write-Host ''
Write-Host '======================== Results ========================'
$log_adapter | Format-Table PSComputerName, Name, Description, Index, Status, MacAddress, LinkSpeed, Slot, Port, PciLabel, NumVFs
