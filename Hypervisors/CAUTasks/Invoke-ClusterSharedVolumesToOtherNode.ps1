...
Param(
	[Parameter()]
	[string]$TaskName = 'Move-ClusterSharedVolumesToOtherNode')
...
Process {
	...
	# report time taken
	Write-Verbose -Verbose -Message "Scheduled task '$TaskName' took '$($StopWatch.Elapsed.TotalSeconds)' seconds to complete"
}
