function Assert-ADScriptStateBaseObjects {
    ...
    # define script state container
    $ScriptStateObjectContainer = 'CN=State,CN={0}' -f $ScriptObjectContainer

    # report object identity
    Write-Verbose -Message "AD Script State container: $ScriptStateObjectContainer"

    # define script object identity
    $script:ScriptStateObjectIdentity = 'CN={0},{1}' -f $ScriptParameterSetName, $ScriptStateObjectContainer

    # report object identity
    Write-Verbose -Message "AD Script State object: $script:ScriptStateObjectIdentity"
}
